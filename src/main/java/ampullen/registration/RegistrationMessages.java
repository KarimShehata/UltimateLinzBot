...
public class RegistrationMessages {
    ...
    public static String AskName = "Wie lautet dein voller Vorname?";
    public static String AskSurName = "Wie lautet dein voller Nachname?";
    public static String AskSex = "Klicke bitte auf dein Geschlecht.";
    public static String AskBirthdate = "Was is dein Geburtsdatum? (31.01.1990)";
    public static String AskEmail = "Wie lautet deine E-Mail Adresse?";
    public static String AskPhone = "Wie lautet deine Telefonnummer? (Bitte nur Zahlen eingeben.)";
